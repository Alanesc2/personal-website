    ...
    function moveHR() {
        ...
        function animate(timestamp) {
            ...
            const gradientAngle = (translateX / amplitude) * 45;
            
            
            hrElement.style.background = `linear-gradient(${gradientAngle}deg, 
                rgba(179, 176, 170),
                rgba(82, 81, 81,0.8))`;
            hrElement.style.boxShadow = `0 0 20px ${Math.abs(translateX/5)}px 
                rgba(232,230,223,0.3)`;
